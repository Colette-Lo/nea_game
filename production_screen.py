...
class ProductionScreen(Screen):
    def __init__(self):
        ...
        self.good_image_paths = []


    def make_tabs(self, tab_name, good_name, location, efficiency, firm_output, image_link):
        ...
        open_image = Image.open(image_link)
        product_photo = ImageTk.PhotoImage(open_image)
        product_photo_lbl = ttk.Label(self.tab_control, image = product_photo)
        product_photo_lbl.pack(padx=10, side="right")
