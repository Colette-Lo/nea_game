...
tryscreen.cal_gdp(0.3)
tryscreen.cal_unemployment(0.3)
tryscreen.cal_inflation(0.3)
tryscreen.cal_happiness(0.3)
tryscreen.cal_literacy(0.3)
tryscreen.cal_life_expectancy(0.3)
